            ...
            child: widget.loading == false
              ...
              child: widget.child ??
                  textWidget(
                    ...
                    color: widget.titleColor ?? AppColors.primaryTextColor,
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: widget.child ?? (widget.icon == null
          ...
          style:  TextStyle(
                  fontSize: widget.fontSize ?? MediaQuery.of(context).size.width/25,
          ...
          children: [
            ...
            SizedBox(
              width: widget.space == null ? 5 : widget.space,
            ),
            Text(
              widget.label == null ? "" : widget.label!,
              style: TextStyle(
...
class Text_Button extends StatelessWidget {
  ...
  Text_Button({this.text, this.fontSize, this.fontWeight, this.textColor, this.onTap, this.padding, this.decoration}) ;
