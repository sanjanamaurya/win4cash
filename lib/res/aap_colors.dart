...
class AppColors {
  ...
  static const percentageColor = Color(0xFF374992);
  static const gradientSecondColor = Color(0xFF2b3270);
  static const filledColor = Color(0xFF323a7c);
  static const btnColor = Color(0xFF757ba6);
  static const btn2Color = Color(0xFF4f69a7);
  static const bottomNavColor = Color(0xFF0a1846);
  static const constColor = Color(0xFF759fde);
  static const iconsColor = Color(0xFF61a9ff);
  static const gridColor = Color(0xFF323a7c);
  ...
  static const secondGoldColor = Color(0xFFdbab6d);
  static const textBtnColor = Color(0xFFED7878);
  static const popUpHeaderColor = Color(0xFF0b1723);
  static const popUpBodyColor = Color(0xFF243165);
  static const btnTextColor = Color(0xFF44260D);
  static const otpBgColor = Color(0xFFc75a22);
  static const textFieldBgColor = Color(0xFF1d1d1d);
  static const primaryBgColor = Color(0xFFA52A2A);
  static const appBarBgColor = Color(0xFF20202c);
  static const containerColor = Color(0xFF544e6a);
  static const containerFirstColor = Color(0xFF211e30);
  static const appConFirstColor = Color(0xFF1b222c);
  static const appConSecondColor = Color(0xFF3b4664);
  static const drawerBgColor = Color(0xFF16161e);
  static const wingoBgColor = Color(0xFF3b1860);
  static const wingoBgConColor = Color(0xFFfeedc1);
  static const wingoGreenColor = Color(0xFF23ae36);
  static const wingoVioletColor = Color(0xFF8b51ff);
  static const wingoRedColor = Color(0xFFff5f49);
  static const wingoTextColor = Color(0xff934F04);


  static const LinearGradient primaryGradient = LinearGradient(
    colors: [Color(0xff374a93), Color(0xff4673cf)],
  );
  static const LinearGradient minesContainer = LinearGradient(
    colors: [Color(0xff045490), Color(0xff013599)],
  );
  static const LinearGradient minesBgColor = LinearGradient(
    colors: [
      Color(0xFF0781cc),
      Color(0xFF046ad2),
      Color(0xFF0258d8),
  ...
  static const LinearGradient topContainerGrad = LinearGradient(
   ...
   // Additional color for the stop
    ],
   // stops: [0.0, 0.5, 0.5, 1.0], // Adjust stops accordingly
  );

  static const LinearGradient buttonGradient = LinearGradient(
    colors: [Color(0xFF757ba6), Color(0xFF757ba6)],
  );
  ...
  static const LinearGradient topBoxGrad = LinearGradient(
    colors: [Color(0xff2979f2), Color(0xff2aaaf3)],
  );
  static const LinearGradient boxGradient = LinearGradient(
    colors: [Color(0xff305298), Color(0xff367acc)],
      begin: Alignment.center,
      end: Alignment.bottomCenter
  );
  static const LinearGradient timeGradient = LinearGradient(
    colors: [Color(0xff384c97), Color(0xff4166bd)],
      begin: Alignment.topLeft,
      end: Alignment.bottomRight
  );

  static  LinearGradient containerCallGradient = LinearGradient(
  ...
  static LinearGradient orangeColorGradient = const LinearGradient(
    colors: [
      Color(0xffFB6C5F),
      Color(0xffFCDCAB),
    ],
  ...
  static LinearGradient goldenGradientDir = const LinearGradient(
    colors: [
      Color.fromARGB(255, 250, 229, 159),
      Color.fromARGB(255, 196, 147, 63),
    ],
  ...
  static LinearGradient goldenGradientDironecolor = const LinearGradient(
      colors: [
        Color.fromARGB(255, 250, 229, 159),
        Color.fromARGB(255, 250, 229, 159),
      ],
