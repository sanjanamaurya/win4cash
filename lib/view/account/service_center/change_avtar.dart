...
import 'package:win4cash/model/changeavtarListmodel.dart';
...
class _ChangeAvtarState extends State<ChangeAvtar> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child:changeAvtar.isEmpty?Center(child: CircularProgressIndicator()):
        GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
              onTap: () {
                ...
                avtarChangeApi(image:changeAvtar[index].image.toString());
              },
              child: Container(
  ...
  avtarChangeApi({required String image}) async {
    UserModel user = await userProvider.getUser();
    String token = user.id.toString();
