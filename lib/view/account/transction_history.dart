...
import 'package:win4cash/model/all_transction_model.dart';
...
class _TransctionHistoryState extends State<TransctionHistory> {
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            allTransactions.isEmpty?Center(child: CircularProgressIndicator()) :
            Expanded(
              child: Padding(
                padding: const EdgeInsets.all(8.0),
  ...
  Future<void> allTransctionHistory() async {
    ...
    final response = await http.get(
      Uri.parse('${ApiUrl.allTranscation}$token&subtypeid=$selectedId'),
