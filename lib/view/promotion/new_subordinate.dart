...
import 'package:win4cash/model/new_subordinate_model.dart';
...
class _NewSubordinateState extends State<NewSubordinate> {
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    textWidget(
                                      text: 'UID: '+data.userName.toString(),
                                      fontWeight: FontWeight.w600,
                                      fontSize: 15,
                                      color: AppColors.primaryTextColor,
                                    ),
  ...
  Future<void> newSubordinate() async {
    ...
    final response = await http.get(
      Uri.parse('${ApiUrl.newSubordinateApi}$token&type=$selectedIndex'),
    );
    if (kDebugMode) {
      print('${ApiUrl.newSubordinateApi}$token&type=$selectedIndex');
