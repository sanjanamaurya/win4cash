...
import 'package:win4cash/view/activity/attendance_rule.dart';
import 'package:win4cash/view/activity/attendence_history.dart';
...
class _AttendenceBonusState extends State<AttendenceBonus> {
  ...
  final   lastItem = attendenceItems.isNotEmpty ? attendenceItems.last : null ;
    ...
    return Scaffold(
        ...
        body:attendenceItems.isEmpty?Center(child: CircularProgressIndicator()):
        ListView(
          children: [
            Container(
  ...
  Future<void> attendenceList() async {
    ...
    if (response.statusCode == 200) {
      ...
      print(accumulated);
      print(attendancesConsecutively);
      print(responseData);
