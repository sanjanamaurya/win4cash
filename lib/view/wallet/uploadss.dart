...
//                 height: height*0.50,
//                     width: width*0.80,
//                 child:imagePath ==""?SizedBox(): Image.network(imagePath),
//               ),
//             ),
//
...
//                   children: [
//                      Text(usdtcode==null?"":usdtcode.toString(), style: TextStyle(
...
//
//   getImage()async{
//     var res= await  http.get(Uri.parse("https://win4cashr.live/admin/index.php/Mahajongapi/usdt_slider"));
//     print(res.body);
//     var data = jsonDecode(res.body)["data"][0];
//     print(data);
//     setState(() {
//       imagePath="https://admin.win4cashr.live/${data["image"]}";
