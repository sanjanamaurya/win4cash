...
import 'package:win4cash/view/home/dragon_tiger_new/coin/single_coin.dart';
import 'package:win4cash/view/home/dragon_tiger_new/dragon_game_history.dart';
import 'package:win4cash/view/home/dragon_tiger_new/dual_ring_animation.dart';
import 'package:win4cash/view/home/dragon_tiger_new/widgets/fade_in_animation.dart';
import 'package:win4cash/view/home/dragon_tiger_new/widgets/random_person.dart';
import 'package:win4cash/view/home/dragon_tiger_new/widgets/stroke_test.dart';
import 'package:win4cash/view/home/dragon_tiger_new/widgets/text_tost.dart';
import 'package:win4cash/view/home/dragon_tiger_new/widgets/updown_border.dart';
import 'package:win4cash/view/home/mini/Aviator/widget/imagetoast.dart';
import 'coin/distribute_coin.dart';
import 'widgets/AnimatedGradientBorder.dart';
                ...
                _isFrontone
                    ...
                    Container(
                      ...
                      decoration:  BoxDecoration(
                          image: DecorationImage(image:AssetImage(Assets.dragontigerFireCard,
                          ),
                              fit: BoxFit.fill
                          )
                      ),
  ...
  Future<void> lastresultview() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        WinResult==1?
        ImageToast.show(
            imagePath: Assets.dragontigerGifDragonAnimated,
            height: 300,
            context: context):
        WinResult==2?
        ImageToast.show(
            imagePath: Assets.dragontigerGifTigerAnimated,
            height: 300,
            context: context):
        TextToast.show(
  ...
  Future<void> bettingApi(String number, String amount,) async {
    try {
      ...
      if (data["status"] == 200) {
        context.read<ProfileProvider>().fetchProfileData();
        ImageToast.show(
          imagePath: Assets.dragontigerBettingplaceds,
          height: 100,
          context: context,
        );
      } else {
