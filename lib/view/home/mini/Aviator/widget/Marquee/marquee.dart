...
import 'package:win4cash/view/home/mini/Aviator/widget/Marquee/fedding_edge.dart';
...
/// ```
///
/// And here's a piece of code that makes full use of the CustomMarquee's
/// customizability:
///
/// ```dart
/// CustomMarquee(
...
class CustomMarquee extends StatefulWidget {
  ...
  /// ## Sample code
  ///
  /// This CustomMarquee has a bold text:
  ///
  /// ```dart
  /// CustomMarquee(
  ...
  /// ## Sample code
  ///
  /// This CustomMarquee has a fixed text scale factor, indipendent to the user selected resolution:
  ///
  /// ```dart
  /// CustomMarquee(
  ///   text: 'This is some bold text.',
  ...
  /// ## Sample code
  ///
  /// This CustomMarquee has a RTL (Right-to-Left) text:
  ///
  /// ```dart
  /// CustomMarquee(
  ///   text: 'טקסט בעברית',
  ...
  /// ## Sample code
  ///
  /// This CustomMarquee scrolls vertically:
  ///
  /// ```dart
  /// CustomMarquee(
  ...
  ///
  /// If a negative velocity is provided, the CustomMarquee scrolls in the reverse
  /// direction (to the right for horizontal CustomMarquees and to the top for
  /// vertical ones).
  ///
  /// ## Sample code
  ///
  /// This CustomMarquee scrolls backwards with 1000 pixels per second:
  ///
  /// ```dart
  /// CustomMarquee(
  ///   velocity: -1000.0,
  ...
  /// ## Sample code
  ///
  /// This [CustomMarquee] starts scrolling one second after being displayed.
  ///
  /// ```dart
  /// CustomMarquee(
  ...
  /// ## Sample code
  ///
  /// After every round, this CustomMarquee pauses for one second.
  ///
  /// ```dart
  /// CustomMarquee(
  ...
  /// ## Sample code
  ///
  /// This CustomMarquee stops after 3 rounds
  ///
  /// ```dart
  /// CustomMarquee(
  ///   numberOfRounds:3,
  ...
  /// ## Sample code
  ///
  /// This CustomMarquee will only show the fade while scrolling.
  ///
  /// ```dart
  /// CustomMarquee(
  ...
  /// The fraction of the [CustomMarquee] that will be faded on the left or top.
  /// By default, there won't be any fading.
  ///
  /// ## Sample code
  ///
  /// This CustomMarquee fades the edges while scrolling
  ///
  /// ```dart
  /// CustomMarquee(
  ///   showFadingOnlyWhenScrolling: true,
  ...
  /// The fraction of the [CustomMarquee] that will be faded on the right or down.
  /// By default, there won't be any fading.
  ///
  /// ## Sample code
  ///
  ...
  ///
  /// In between rounds, the CustomMarquee stops at this position. This parameter is
  /// especially useful if the CustomMarquee pauses after rounds and some other
  /// widgets are stacked on top of the CustomMarquee and block the sides, like
  /// fading gradients.
  ///
  /// ## Sample code
  ///
  ...
  /// ## Sample code
  ///
  /// A CustomMarquee that slowly accelerates in two seconds.
  ///
  /// ```dart
  /// CustomMarquee(
  ...
  /// ## Sample code
  ///
  /// A CustomMarquee that accelerates with a custom curve.
  ///
  /// ```dart
  /// CustomMarquee(
  ///   accelerationDuration: Duration(seconds: 1),
  ...
  /// ## Sample code
  ///
  /// A CustomMarquee that gradually comes to a halt in two seconds.
  ///
  /// ```dart
  /// CustomMarquee(
  ...
  /// ## Sample code
  ///
  /// A CustomMarquee that decelerates with a custom curve.
  ///
  /// ```dart
  /// CustomMarquee(
  ...
  /// This function will be called if [numberOfRounds] is set and the [CustomMarquee]
...
class _CustomMarqueeState extends State<CustomMarquee> with SingleTickerProviderStateMixin {
  ...
  void didUpdateWidget(Widget oldWidget) {
    super.didUpdateWidget(oldWidget as CustomMarquee);
  }
