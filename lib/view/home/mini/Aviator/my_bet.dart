...
import 'package:win4cash/view/home/mini/Aviator/aviator_model/my_bet_model.dart';
...
class _MyBetPageState extends State<MyBetPage> {
                  ...
                  return Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          color: bets[index].multiplier=='null'?Colors.black:Color(0xff123304),
                          border: Border.all(color: bets[index].multiplier=='null'?Colors.white60:Color(0xff406b1f)),
                        ...
                        children: [
                          Container(
                            height: 25,
                              alignment: Alignment.centerLeft,
                              width: width * 0.3,
                              child:Text('2024'+bets[index].gameSrNum.toString(),
                                  maxLines: 1,
  ...
  Future<void> myBet() async {
    ...
    //final url = "https://admin.play-zone.live/api/aviator/bet_histroy?userid=$userid";
    try {
