...
import 'package:win4cash/view/home/lottery/trx/trx_my_history_details.dart';
import 'package:win4cash/view/home/lottery/trx/trx_web_block.dart';
import 'package:win4cash/view/home/lottery/trx/trx_web_one.dart';
                                    ...
                                    InkWell(
                                      onTap: (){
                                        showDialog(
                                            ...
                                            builder: (BuildContext context)
                                            {
                                              return const HowToPlay(type:AppConstants.trxGameRule);
                                            });
                                      },
                                      child: Container(
                                          padding: const EdgeInsets.symmetric(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                ...
                                return Row(
                                  ...
                                  children: characterList.map((char) {
                                    print(gameResult[index].number.toString());
                                    print(betNumbers[index].number.toString());
                                    print('wsxcde');
